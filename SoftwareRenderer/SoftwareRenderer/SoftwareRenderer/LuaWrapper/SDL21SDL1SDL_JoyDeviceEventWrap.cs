...
namespace UniToLua
{
    ...
    public class SDL21SDL1SDL_JoyDeviceEventWrap
    {
        
        public static void Register(UniLua.ILuaState L)
        {
			L.BeginClass(typeof(SDL2.SDL.SDL_JoyDeviceEvent), typeof(System.ValueType));
			L.RegFunction("New", _CreateSDL21SDL1SDL_JoyDeviceEvent);
        ...
        private static int _CreateSDL21SDL1SDL_JoyDeviceEvent(UniLua.ILuaState L)
        {
			if(L.CheckNum(0)) {
				L.PushAny<SDL2.SDL.SDL_JoyDeviceEvent>(default(SDL2.SDL.SDL_JoyDeviceEvent));
				return 1;
			}
			L.L_Error("call SDL_JoyDeviceEvent constructor args is error");
			return 1;
        }
        
        private static int get_type(UniLua.ILuaState L)
        {
			var obj = (SDL2.SDL.SDL_JoyDeviceEvent) L.ToUserData(1);
        ...
        private static int set_type(UniLua.ILuaState L)
        {
			...
			obj.type = value;
			// replace old struct
			L.PushAny<SDL2.SDL.SDL_JoyDeviceEvent>(obj);
			L.Replace(1);
			return 0;
        }
        ...
        {
			if(L.CheckNum(2) && L.CheckType<SDL2.SDL.SDL_JoyDeviceEvent, object>(1))
			{
				bool result;
				var obj = (SDL2.SDL.SDL_JoyDeviceEvent) L.ToUserData(1);

...
namespace UniToLua
{
    ...
    public class SDL21SDL1SDL_ControllerDeviceEventWrap
    {
        
        public static void Register(UniLua.ILuaState L)
        {
			L.BeginClass(typeof(SDL2.SDL.SDL_ControllerDeviceEvent), typeof(System.ValueType));
			L.RegFunction("New", _CreateSDL21SDL1SDL_ControllerDeviceEvent);
        ...
        {
			if(L.CheckNum(2) && L.CheckType<SDL2.SDL.SDL_ControllerDeviceEvent, object>(1))
			{
				bool result;
				var obj = (SDL2.SDL.SDL_ControllerDeviceEvent) L.ToUserData(1);

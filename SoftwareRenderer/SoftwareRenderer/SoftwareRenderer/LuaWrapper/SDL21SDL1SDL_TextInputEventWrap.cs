...
namespace UniToLua
{
    ...
    public class SDL21SDL1SDL_TextInputEventWrap
    {
        
        public static void Register(UniLua.ILuaState L)
        {
			L.BeginClass(typeof(SDL2.SDL.SDL_TextInputEvent), typeof(System.ValueType));
			L.RegFunction("New", _CreateSDL21SDL1SDL_TextInputEvent);
        ...
        private static int _CreateSDL21SDL1SDL_TextInputEvent(UniLua.ILuaState L)
        {
			if(L.CheckNum(0)) {
				L.PushAny<SDL2.SDL.SDL_TextInputEvent>(default(SDL2.SDL.SDL_TextInputEvent));
				return 1;
			}
			L.L_Error("call SDL_TextInputEvent constructor args is error");
			return 1;
        }
        
        private static int get_type(UniLua.ILuaState L)
        {
			var obj = (SDL2.SDL.SDL_TextInputEvent) L.ToUserData(1);
        ...
        private static int set_type(UniLua.ILuaState L)
        {
			...
			obj.type = value;
			// replace old struct
			L.PushAny<SDL2.SDL.SDL_TextInputEvent>(obj);
			L.Replace(1);
			return 0;
        }
        ...
        {
			if(L.CheckNum(2) && L.CheckType<SDL2.SDL.SDL_TextInputEvent, object>(1))
			{
				bool result;
				var obj = (SDL2.SDL.SDL_TextInputEvent) L.ToUserData(1);

...
namespace UniToLua
{
    ...
    public class SDL21SDL1SDL_UserEventWrap
    {
        
        public static void Register(UniLua.ILuaState L)
        {
			L.BeginClass(typeof(SDL2.SDL.SDL_UserEvent), typeof(System.ValueType));
			L.RegFunction("New", _CreateSDL21SDL1SDL_UserEvent);
        ...
        private static int _CreateSDL21SDL1SDL_UserEvent(UniLua.ILuaState L)
        {
			if(L.CheckNum(0)) {
				L.PushAny<SDL2.SDL.SDL_UserEvent>(default(SDL2.SDL.SDL_UserEvent));
				return 1;
			}
			L.L_Error("call SDL_UserEvent constructor args is error");
			return 1;
        }
        
        private static int get_type(UniLua.ILuaState L)
        {
			var obj = (SDL2.SDL.SDL_UserEvent) L.ToUserData(1);
        ...
        private static int set_type(UniLua.ILuaState L)
        {
			...
			obj.type = value;
			// replace old struct
			L.PushAny<SDL2.SDL.SDL_UserEvent>(obj);
			L.Replace(1);
			return 0;
        }
        ...
        private static int get_code(UniLua.ILuaState L)
        {
			var obj = (SDL2.SDL.SDL_UserEvent) L.ToUserData(1);
			L.PushAny<int>(obj.code);
			return 1;
        }
        
        private static int set_code(UniLua.ILuaState L)
        {
			var obj = (SDL2.SDL.SDL_UserEvent) L.ToUserData(1);
        ...
        {
			var obj = (SDL2.SDL.SDL_UserEvent) L.ToUserData(1);
			L.PushAny<System.IntPtr>(obj.data1);
			return 1;
        }
        ...
        {
			var obj = (SDL2.SDL.SDL_UserEvent) L.ToUserData(1);
			L.PushAny<System.IntPtr>(obj.data2);
			return 1;
        }
        ...
        {
			if(L.CheckNum(2) && L.CheckType<SDL2.SDL.SDL_UserEvent, object>(1))
			{
				bool result;
				var obj = (SDL2.SDL.SDL_UserEvent) L.ToUserData(1);

...
namespace UniToLua
{
    ...
    public class SoftwareRenderer1Core1WorldWrap
    {
        
        public static void Register(UniLua.ILuaState L)
        {
			L.BeginClass(typeof(SoftwareRenderer.Core.World), typeof(SoftwareRenderer.Core.WorldObject));
			L.RegFunction("New", _CreateSoftwareRenderer1Core1World);
        ...
        private static int _CreateSoftwareRenderer1Core1World(UniLua.ILuaState L)
        {
			if(L.CheckNum(0))
			{
				L.PushAny<SoftwareRenderer.Core.World>(new SoftwareRenderer.Core.World());
				return 1;
			}
			L.L_Error("call World constructor args is error");
			return 1;
        }
        ...
        {
			if(L.CheckNum(2) && L.CheckType<SoftwareRenderer.Core.World, object>(1))
			{
				bool result;
				var obj = (SoftwareRenderer.Core.World) L.ToUserData(1);

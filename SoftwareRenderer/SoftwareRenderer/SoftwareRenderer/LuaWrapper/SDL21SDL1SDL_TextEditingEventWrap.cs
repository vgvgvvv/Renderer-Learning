...
namespace UniToLua
{
    ...
    public class SDL21SDL1SDL_TextEditingEventWrap
    {
        
        public static void Register(UniLua.ILuaState L)
        {
			L.BeginClass(typeof(SDL2.SDL.SDL_TextEditingEvent), typeof(System.ValueType));
			L.RegFunction("New", _CreateSDL21SDL1SDL_TextEditingEvent);
        ...
        private static int _CreateSDL21SDL1SDL_TextEditingEvent(UniLua.ILuaState L)
        {
			if(L.CheckNum(0)) {
				L.PushAny<SDL2.SDL.SDL_TextEditingEvent>(default(SDL2.SDL.SDL_TextEditingEvent));
				return 1;
			}
			L.L_Error("call SDL_TextEditingEvent constructor args is error");
			return 1;
        }
        ...
        {
			if(L.CheckNum(2) && L.CheckType<SDL2.SDL.SDL_TextEditingEvent, object>(1))
			{
				bool result;
				var obj = (SDL2.SDL.SDL_TextEditingEvent) L.ToUserData(1);

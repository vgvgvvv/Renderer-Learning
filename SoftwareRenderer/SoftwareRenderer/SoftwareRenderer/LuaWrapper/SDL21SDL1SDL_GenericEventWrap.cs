...
namespace UniToLua
{
    ...
    public class SDL21SDL1SDL_GenericEventWrap
    {
        
        public static void Register(UniLua.ILuaState L)
        {
			L.BeginClass(typeof(SDL2.SDL.SDL_GenericEvent), typeof(System.ValueType));
			L.RegFunction("New", _CreateSDL21SDL1SDL_GenericEvent);
        ...
        {
			if(L.CheckNum(2) && L.CheckType<SDL2.SDL.SDL_GenericEvent, object>(1))
			{
				bool result;
				var obj = (SDL2.SDL.SDL_GenericEvent) L.ToUserData(1);

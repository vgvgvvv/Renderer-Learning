...
namespace UniToLua
{
    ...
    public class SDL21SDL1SDL_AudioDeviceEventWrap
    {
        
        public static void Register(UniLua.ILuaState L)
        {
			L.BeginClass(typeof(SDL2.SDL.SDL_AudioDeviceEvent), typeof(System.ValueType));
			L.RegFunction("New", _CreateSDL21SDL1SDL_AudioDeviceEvent);
			L.RegVar("type", get_type, set_type);
			L.RegVar("timestamp", get_timestamp, set_timestamp);
			L.RegVar("which", get_which, set_which);
			L.RegVar("iscapture", get_iscapture, set_iscapture);
        ...
        private static int get_iscapture(UniLua.ILuaState L)
        {
			var obj = (SDL2.SDL.SDL_AudioDeviceEvent) L.ToUserData(1);
			L.PushAny<byte>(obj.iscapture);
			return 1;
        }
        
        private static int set_iscapture(UniLua.ILuaState L)
        {
			var obj = (SDL2.SDL.SDL_AudioDeviceEvent) L.ToUserData(1);
        ...
        {
			if(L.CheckNum(2) && L.CheckType<SDL2.SDL.SDL_AudioDeviceEvent, object>(1))
			{
				bool result;
				var obj = (SDL2.SDL.SDL_AudioDeviceEvent) L.ToUserData(1);

...
namespace UniToLua
{
    ...
    public class SDL21SDL1SDL_MouseButtonEventWrap
    {
        
        public static void Register(UniLua.ILuaState L)
        {
			L.BeginClass(typeof(SDL2.SDL.SDL_MouseButtonEvent), typeof(System.ValueType));
			L.RegFunction("New", _CreateSDL21SDL1SDL_MouseButtonEvent);
			...
			L.RegVar("clicks", get_clicks, set_clicks);
        ...
        private static int _CreateSDL21SDL1SDL_MouseButtonEvent(UniLua.ILuaState L)
        {
			if(L.CheckNum(0)) {
				L.PushAny<SDL2.SDL.SDL_MouseButtonEvent>(default(SDL2.SDL.SDL_MouseButtonEvent));
				return 1;
			}
			L.L_Error("call SDL_MouseButtonEvent constructor args is error");
			return 1;
        }
        
        private static int get_type(UniLua.ILuaState L)
        {
			var obj = (SDL2.SDL.SDL_MouseButtonEvent) L.ToUserData(1);
        ...
        private static int set_type(UniLua.ILuaState L)
        {
			...
			obj.type = value;
			// replace old struct
			L.PushAny<SDL2.SDL.SDL_MouseButtonEvent>(obj);
			L.Replace(1);
			return 0;
        }
        ...
        private static int get_clicks(UniLua.ILuaState L)
        {
			var obj = (SDL2.SDL.SDL_MouseButtonEvent) L.ToUserData(1);
			L.PushAny<byte>(obj.clicks);
			return 1;
        }
        
        private static int set_clicks(UniLua.ILuaState L)
        {
			var obj = (SDL2.SDL.SDL_MouseButtonEvent) L.ToUserData(1);
			var value = L.CheckAny<byte>(2);
			obj.clicks = value;
        ...
        {
			if(L.CheckNum(2) && L.CheckType<SDL2.SDL.SDL_MouseButtonEvent, object>(1))
			{
				bool result;
				var obj = (SDL2.SDL.SDL_MouseButtonEvent) L.ToUserData(1);

...
namespace UniToLua
{
    ...
    public class SDL21SDL1SDL_HapticConditionWrap
    {
        
        public static void Register(UniLua.ILuaState L)
        {
			L.BeginClass(typeof(SDL2.SDL.SDL_HapticCondition), typeof(System.ValueType));
			L.RegFunction("New", _CreateSDL21SDL1SDL_HapticCondition);
        ...
        {
			if(L.CheckNum(2) && L.CheckType<SDL2.SDL.SDL_HapticCondition, object>(1))
			{
				bool result;
				var obj = (SDL2.SDL.SDL_HapticCondition) L.ToUserData(1);

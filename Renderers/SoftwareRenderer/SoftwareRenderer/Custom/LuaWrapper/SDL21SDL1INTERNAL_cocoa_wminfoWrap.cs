...
namespace UniToLua
{
    ...
    public class SDL21SDL1INTERNAL_cocoa_wminfoWrap
    {
        
        public static void Register(UniLua.ILuaState L)
        {
			L.BeginClass(typeof(SDL2.SDL.INTERNAL_cocoa_wminfo), typeof(System.ValueType));
			L.RegFunction("New", _CreateSDL21SDL1INTERNAL_cocoa_wminfo);
        ...
        {
			if(L.CheckNum(2) && L.CheckType<SDL2.SDL.INTERNAL_cocoa_wminfo, object>(1))
			{
				bool result;
				var obj = (SDL2.SDL.INTERNAL_cocoa_wminfo) L.ToUserData(1);
